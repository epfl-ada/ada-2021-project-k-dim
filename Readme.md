...
4) [Clusterization](https://github.com/epfl-ada/ada-2021-project-k-dim/blob/main/code/Milestone_3/Clusterization.ipynb) which contains 4 different types of clusterization performed on additional dataset, from Milestone 3.
